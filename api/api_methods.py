...
class saml:
    ...
    def get_certificate_with_header(certificate_in_string):
    ...
    def format_certificate(cert_data_in_string):
        format_cert = parse_xml.format_certificate(cert_data_in_string)
        return format_cert
        
    def get_xml_content(xml_body_in_string):
    ...
    def validate_entity_id(entityId):
