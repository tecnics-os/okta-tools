...
@pytest.mark.parametrize("hash_type", [('sha1'), ('sha224'), ('sha256'), ('sha384'), ('sha3_224'), ('sha3_256'), ('sha3_284'), ('sha512')])
def test_random_hash(hash_type):
    print(hash_type)
    hashed = "e9a75486736a550af4fea861e2378305c4a555a05094dee1dca2f68afea49cc3a50e8de6ea131ea521311f4d6fb054a146e8282f8e35ff2e6368c1a62e909716"
    status = password_checker.hashlib_verify("password", hashed, hash_type)
    assert status !='success, Its a valid password hash'
